...
class CategoryManager implements CategoryManagerInterface {
   ...
   */
  public function __construct(EntityTypeManagerInterface $entity_type_manager, ClientFactory $client_factory, APIWrapper $api_wrapper, LoggerChannelFactory $logger_factory, I18nHelper $i18nHelper, ModuleHandlerInterface $moduleHandler, Connection $connection) {
